...
Небольшой сервис регистрации и авторизации. После регистрации пользователь создаётся в API, событие `user.registered` отправляется в RabbitMQ, а отдельный worker асинхронно создаёт профиль.
